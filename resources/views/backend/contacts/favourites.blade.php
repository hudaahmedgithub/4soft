...
@section('content')
            ...
            <aside class="page-aside">
                ...
                <div class="aside-content">
                    ...
                    <li><a href="{{ route('contacts.inbox') }}"><span class="badge badge-primary">{{ $inboxContacts }}</span><i class="icon mdi mdi-inbox"></i>Inbox</a></li>
                        ...
                        <li class="active"><a href="#"><i class="icon mdi mdi-star"></i>Favourites</a></li>
            ...
            <div class="main-content container-fluid " style="margin-top:-25px;margin-left:">
              <div class="email-inbox-header">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="email-title"><span class="icon mdi mdi-inbox"></span> Favourites <span class="new-messages">  {{ DB::table("contacts")->where('favourite', '=', '1')->count('*') }} messages</span>  </div>
                  </div>
                  <div class="col-lg-6">
              ...
              @empty
                 <div class="email-list-item text-center">No Favourites</div>
              @endforelse
