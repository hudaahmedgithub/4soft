...
@section('content')
            ...
            <aside class="page-aside">
                ...
                <div class="aside-content">
                    ...
                    <ul class="nav">
                        ...
                        <li class="active"  ><a href="#"><i class="icon mdi mdi-delete"></i>Trash</a></li>
                    </ul>
            ...
            <div class="main-content container-fluid " style="margin-top:-25px;margin-left:">
              <div class="email-inbox-header">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="email-title"><span class="icon mdi mdi-inbox"></span> Trashed Items <span class="new-messages"> ...</span>  </div>
                  </div>
                  <div class="col-lg-6">
              ...
              <div class="email-filters">
                ...
                <div class="email-list-item">
                  ...
                  <form action="{{ route('contacts.trashDestroy', ['id'=>$contact->id]) }}" method="post">
                      @csrf
                      @method('DELETE')
                  ...
                  <form action="{{ route('contacts.trashPost', ['id'=>$contact->id]) }}" method="post">
                      @csrf
                      @method('PUT')
                      <i class="icon text-success mdi mdi-time-restore restore_icon" style="display:none;font-size:30px;position:absolute;right:0;"><button style="width: 20px;position: absolute;right: -1px;height: 28px;opacity:0;" class=""></button></i>
                  </form>
                ...
                @empty
                  <div class="email-list-item text-center">No Trashed Mails / Messages</div>
                @endforelse
...
<script>
    $(document).ready(function() {
        ...
        $(".email-list-item").hover(function(){
              ...
              $(this).find('.restore_icon').show().animate({
                right: "25%",
                top: "11%",
            }, 300);
        }, function(){
            ...
            $(this).find('.restore_icon').animate({
              right: "0",
              top: "11%",
          }, 300).hide(200);
        });
