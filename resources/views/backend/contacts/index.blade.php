...
@section('content')
            ...
            <div class="main-content container-fluid " style="margin-top:-25px;margin-left:">
              ...
              <div class="email-inbox-header">
                <div class="row">
                  <div class="col-lg-6">
                    <div class="email-title"><span class="icon mdi mdi-inbox"></span> Our Sent Mails <span class="new-messages"></span>  </div>
                  </div>
                  <div class="col-lg-6">
              ...
              <div class="email-filters">
                ...
                <div class="email-filters-right">
                  <span class="email-pagination-indicator"> {{ DB::table("contacts")->where('type', '=', 'sender')->count('*') }} Messages</span>
                </div>
              </div>
